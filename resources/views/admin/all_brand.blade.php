  ...
  <div class="panel panel-default">
    ...
    <div class="row w3-res-tb">
      ...
      <div class="col-sm-3">
        ...
        <form action="{{URL::to('/search-brand')}}" method="POST">
								{{csrf_field()}}
						<input type="text" style="font-size: 17px; width: 200px;"   name="search_brand" placeholder="Tìm kiếm sản phẩm"/>
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
        <form onclick="return confirm('Are you sure delete?')" action="{{URL::to('/delete-all-brand')}}" method="POST">
								{{csrf_field()}}
						
						<input class="btn btn-primary btn-sm" style="margin-top: -4px;
    					color: white; font-size: 17px;  " type="submit" value="Xóa tất cả" name="send_oder">
					</form>
        <form action="{{URL::to('/delete-box-category')}}" method="POST">
								{{csrf_field()}}
          ...
          <tr>
            <td><label class="i-checks m-b-none"><input type="checkbox" value="$cate_pro->brand_id" name="check[]"><i></i></label></td>
            ...
            <a onclick="return confirm('Are you sure delete?')" href="{{URL::to('delete-brand-product',$cate_pro->brand_id)}}" class="active" ui-toggle-class="">
