  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
        <form onclick="return confirm('Are you sure delete?')" action="{{URL::to('/delete-all-category')}}" method="POST">
								{{csrf_field()}}
        ...
        <form action="{{URL::to('/delete-box-category')}}" method="POST">
          ...
          <tr>
            ...
            <input type="checkbox" class="sub_hk"  name="check[]" value="{{$cate_pro->category_id}}"><i></i></label></td>
